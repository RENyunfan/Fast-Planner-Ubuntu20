...
struct MappingData {
    ...
    pcl::PointCloud<pcl::PointXYZ> pc_, last_pc_;
...
private:
    ...
    void pcOdomCallback(const sensor_msgs::PointCloud2ConstPtr &img, const nav_msgs::OdometryConstPtr &odom);
    ...
    typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::PointCloud2 , nav_msgs::Odometry>
            SyncPolicyPcOdom;
    typedef shared_ptr<message_filters::Synchronizer<SyncPolicyPcOdom>> SynchronizerPcOdom;
    ...
    shared_ptr<message_filters::Subscriber<sensor_msgs::PointCloud2>> pc_sub_;
    SynchronizerImagePose sync_image_pose_;
    SynchronizerImageOdom sync_image_odom_;
    SynchronizerPcOdom sync_pc_odom_;
